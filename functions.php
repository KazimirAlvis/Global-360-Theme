...
if (!function_exists('global_360_get_icon_svg')) {
	...
	function global_360_get_icon_svg($icon, $classes = '') {
		static $icon_map = [
			...
			'threads' => [
				'viewBox' => '0 0 448 512',
				'paths'   => '<path d="M331.5 235.7c2.2 .9 4.2 1.9 6.3 2.8c29.2 14.1 50.6 35.2 61.8 65.4c15.7 42.3 15.6 86.1-4.6 126.2c-16.5 32.9-43.3 57.7-78.6 74.5c-57.7 27.4-129.6 28.1-188.8 3.4C48.5 474.6 5.8 394.3 .2 311.7c-3.3-48.8 7.3-94.9 34.6-136.2C67.8 122 113.8 89.4 167.4 76.5C213.8 65.3 260.9 66 306 82.5c53.8 19.7 93.4 56.8 115.7 109.7c1.2 2.9 1.1 3.6-2 3.6c-26.2 .1-52.4 .1-78.5 .2c-1.5 0-2.3-.5-3-1.9c-13.6-29.5-35.2-49.9-66.2-59.6c-48.2-15.1-94.9-8.1-136.1 22.9c-29.4 22.1-48.3 51.2-57.4 86.9c-7.3 28.6-6.5 57.7 .8 86.1c12 46.8 40.4 78.1 84.4 94.4c31.7 11.7 63.9 11.4 95.3-1.5c24.9-10.2 43.7-27.5 54.2-52.5c4.5-10.8 7-22.2 6.8-34.3c-.5-21.2-9.1-38.1-27.6-49.7c-1.4-.9-2.9-1.7-4.7-2.7c0 .9-.1 1.5-.1 2.1c-.2 18-5.1 34.6-15.2 49.5c-12.7 18.8-30.1 31.3-51.9 37.1c-33.4 8.9-65.1 4.8-93.6-14.4c-19.4-13.1-32.5-31.3-38.5-54c-8.2-31.1-2.3-60.9 18.1-85.7c16.7-20.3 38.8-32 64.9-35.5c21.7-2.9 43 1.3 62.8 10.8c1.8 .9 3.4 1.8 5.2 2.8c0-2.7 .1-5.3 0-7.8c-.2-10.7-2.2-21-7.3-30.5c-8.2-15.3-21.2-24.7-37.9-29.3c-17.8-4.9-35.6-4.2-53.2 .6c-16.6 4.5-31.2 12.8-44.3 23.9c-1.3 1.1-2.5 1.6-4.2 1.6c-26.8-.1-53.6-.1-80.4-.1h-2.4c.1-1.3 .4-2.3 .8-3.3c24.3-56.7 66.8-91.9 127.3-104.4c41.2-8.5 82.3-6.4 123.1 5.8c27.7 8.3 53 21.6 75.4 39.6c24.4 19.6 41.3 44.6 48.6 75.4c2.1 9 3.4 18.2 5 27.3c.3 1.8 .5 3.6 .8 5.4z"/>'
			],
			'youtube' => [
				'viewBox' => '0 0 640 640',
